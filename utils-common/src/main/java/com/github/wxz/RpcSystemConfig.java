...
public class RpcSystemConfig {
    ...
    public static final int SYSTEM_PROPERTY_THREAD_POOL_THREAD_NUMS = Integer.getInteger("nettyrpc.default.thread.nums", 16);
    public static final int SYSTEM_PROPERTY_THREAD_POOL_QUEUE_NUMS = Integer.getInteger("nettyrpc.default.queue.nums", -1);
