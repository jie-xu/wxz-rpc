...
//
//
//import com.github.wxz.core.exception.UncheckedTemplateException;
//
...
//
//    private HttpTemplate(String str) {
//        this.str = str;
//    }
//
//    public static HttpTemplate template(String str) {
//        return new HttpTemplate(str);
//    }
//
//    public static HttpTemplate template(String str, Object... args) {
//        return template(str).args(args);
//    }
//
//    public static HttpTemplate template(String str, Map<String, Object> args) {
//        return template(str).args(args);
//    }
//
//    public static HttpTemplate fromFile(String strPath) {
//        return template(readFromFile(strPath));
//    }
//
//    public static HttpTemplate fromFile(String strPath, Charset encoding) {
//        return template(readFromFile(strPath, encoding));
//    }
//
//    public static HttpTemplate fromFile(String strPath, Object... args) {
//        return template(readFromFile(strPath), args);
//    }
//
//    public static HttpTemplate fromFile(String strPath, Charset encoding, Object... args) {
//        return template(readFromFile(strPath, encoding), args);
//    }
//
//    public static HttpTemplate fromFile(String strPath, Map<String, Object> args) {
//        return template(readFromFile(strPath), args);
//    }
//
//    public static HttpTemplate fromFile(String strPath, Charset encoding, Map<String, Object> args) {
//        return template(readFromFile(strPath, encoding), args);
//    }
//
...
//    }
//
//    public HttpTemplate arg(String argName, Object object) {
//        failIfArgExists(argName);
//        this.arguments.put(argName, object);
//        return this;
//    }
//
//    public HttpTemplate args(Map<String, Object> args) {
...
//    }
//
//    public HttpTemplate args(Object... args) {
//        if (args.length % 2 == 1) {
//
